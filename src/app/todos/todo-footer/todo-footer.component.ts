...
export class TodoFooterComponent implements OnInit {
  ...
  filtrosFooter: actions.filtrosValidos[] = ['todos','completados','pendientes'];
  ...
  ngOnInit(): void {
    ...
    this.store.subscribe( state => {
      ...
      this.pendientes = state.todos.filter( todo => !todo.completado ).length; //para contar los pendientes
    } );
